...
// funcMap is a map that maps kafka message keys to functions used to send out different emails
var funcMap = map[string]interface{}{
	"confirm-account": email.SendConfirmAccountEmail,
}
...
func main() {
	...
	r := kafka.NewReader(c)
	fmt.Println("Kafka consumer listening on topic \"email\"")
