...
func (ec *executionContext) _Mutation_register(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	var arg0 RegisterArgs
	if tmp, ok := rawArgs["args"]; ok {
		var err error
		arg0, err = UnmarshalRegisterArgs(tmp)
		if err != nil {
			ec.Error(ctx, err)
			return graphql.Null
		}
	...
	defer rctx.Pop()
	resTmp := ec.FieldMiddleware(ctx, func(ctx context.Context) (interface{}, error) {
		return ec.resolvers.Mutation().Register(ctx, args["args"].(RegisterArgs))
	})
	if resTmp == nil {
		return graphql.Null
	}
...
func (ec *executionContext) _Mutation_login(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	if tmp, ok := rawArgs["args"]; ok {
		var err error
		arg0, err = UnmarshalLoginArgs(tmp)
		if err != nil {
			ec.Error(ctx, err)
			return graphql.Null
		}
	...
	defer rctx.Pop()
	resTmp := ec.FieldMiddleware(ctx, func(ctx context.Context) (interface{}, error) {
		return ec.resolvers.Mutation().Login(ctx, args["args"].(LoginArgs))
	})
	if resTmp == nil {
		return graphql.Null
	}
...
func (ec *executionContext) _Query(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "getUsers":
			out.Values[i] = ec._Query_getUsers(ctx, field)
		case "__type":
...
func (ec *executionContext) _Session_roles(ctx context.Context, field graphql.CollectedField, obj *Session) graphql.Marshaler {
	rctx := graphql.GetResolverContext(ctx)
	rctx.Object = "Session"
	rctx.Args = nil
	rctx.Field = field
...
func UnmarshalLoginArgs(v interface{}) (LoginArgs, error) {
	var it LoginArgs
...
func UnmarshalRegisterArgs(v interface{}) (RegisterArgs, error) {
	var it RegisterArgs
	var asMap = v.(map[string]interface{})
	...
	for k, v := range asMap {
		...
		case "passwordConf":
			var err error
			it.PasswordConf, err = graphql.UnmarshalString(v)
			if err != nil {
				return it, err
			}
		}
