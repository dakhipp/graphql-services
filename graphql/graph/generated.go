...
func (s shortMapper) Query_getUsers(ctx context.Context) ([]User, error) {
	return s.r.Query().GetUsers(ctx)
}
...
func (ec *executionContext) _Mutation_register(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(ctx context.Context) (interface{}, error) {
		return ec.resolvers.Mutation_register(ctx, args["user"].(RegisterArgs))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_getUsers(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	return graphql.Defer(func() (ret graphql.Marshaler) {
		...
		resTmp, err := ec.ResolverMiddleware(ctx, func(ctx context.Context) (interface{}, error) {
			return ec.resolvers.Query_getUsers(ctx)
		})
		if err != nil {
			ec.Error(ctx, err)
			return graphql.Null
